const projects = [
  {
    ...
    files: [
      { name: "Swagplug Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "Swagplug Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "Swagplug Logo.Zip", size: "2.02 MB", link: "#" },
